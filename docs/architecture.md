...
- Local stack: `docker compose up` always runs the frontend and uses root `BACKEND_MODE` (`Laravel`, `Nest`, or `Both`) to select the matching backend services through Docker Compose profiles.
