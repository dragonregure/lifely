...
Lifely frontend is a React CRM single-page app for real estate offices. It talks to the Laravel API through a configurable base URL and uses the backend for authentication, contacts, listings, pipeline, email campaign, activity, and reporting data.
